...
- Prefer common selectors like input[name="q"] for search boxes
...
"""
    ...
    def decide_next_action(self, task: str, page_text: str) -> Dict[str, Any]:
        """
...
"""
    ...
    def _parse_json_response(self, response_text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            valid_actions = ["navigate", "click", "type", "extract", "finish"]
